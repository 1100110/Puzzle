    ...
    void reserve(size_t newCapacity) {
        ...
        if (this._data.capacity < newCapacity) {
            ...
            if (u) {
                ...
                this._data.arr = (cast(T*) bi.base)[0 .. len];
...
private:
   ...
   static size_t newCapacity(size_t newlength) pure nothrow {
        ...
        if (mult > 200)
			mult = 200;
        size_t newext = cast(size_t)((newlength * mult + 99) / 100);
...
public:
	...
	*/
static if (__traits(compiles, { this._data.arr[len] = item; })) {
    void put(U)(U item) if (canPutItem!U) {
		this.ensureAddable(1);
		
		immutable size_t len = this._data.arr.length;
		this._data.arr.ptr[len] = item;
